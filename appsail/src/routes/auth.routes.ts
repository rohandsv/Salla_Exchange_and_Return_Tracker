    ...
    return res
      ...
      .send(
        renderHtml({
          ...
          heading: "✅ Salla OAuth Connected",
          body: `<p>Connection completed successfully.</p>
<p><b>Verified:</b> ${result?.verified ? "Yes" : "No"}</p>
      ...
      return res
        ...
        .send(
          renderHtml({
            ...
            heading: "❌ Salla OAuth Failed",
            body: `<p><b>Error:</b> ${escapeHtml(String(e.message || "Unknown error"))}</p>
<p><b>Code:</b> ${escapeHtml(String((e as any).code || "UNKNOWN"))}</p>
${
  (e as any).details
